...
class EssentialTest {
    ...
    @Test
    fun testNegate() {
        assertTrue { Sampler.abstractBigInt(256).abs().negate() < BigInt.zero }
    }
    ...
    @Test
    fun testUnaryMinus() {
        assertTrue { Sampler.abstractBigInt(256).abs().unaryMinus() < BigInt.zero }
    }
    ...
    @Test
    fun testAbs() {
        assertTrue { Sampler.abstractBigInt(256).negate().abs() > BigInt.zero }
    }
    ...
    @Test
    fun testMax() {
        val small = Sampler.abstractBigInt(256)
        val large = small.inc()
