...
class DivisionTest {
    ...
    fun testLongPosDivShortPos32x17(): Unit = repeat(loops) {
        val bigIntLongPos = Sampler.abstractBigInt(32).abs()
        val bigIntShortPos = Sampler.abstractBigInt(17)
    ...
    fun testLongPosDivShortNeg32x17(): Unit = repeat(loops) {
        val bigIntLongPos = Sampler.abstractBigInt(32).abs()
        val bigIntShortNeg = Sampler.abstractBigInt(17).abs().negate()
    ...
    fun testLongNegDivShortPos32x17(): Unit = repeat(loops) {
        val bigIntLongNeg = Sampler.abstractBigInt(32).abs().negate()
        val bigIntShortPos = Sampler.abstractBigInt(17).abs()
    ...
    fun testLongPosDivShortPos125x31(): Unit = repeat(loops) {
        val bigIntLongPos = Sampler.abstractBigInt(125).abs()
        val bigIntShortPos = Sampler.abstractBigInt(31)
    ...
    fun testLongPosDivShortNeg125x31(): Unit = repeat(loops) {
        val bigIntLongPos = Sampler.abstractBigInt(125).abs()
        val bigIntShortNeg = Sampler.abstractBigInt(31).abs().negate()
    ...
    fun testLongNegDivShortPos125x31(): Unit = repeat(loops) {
        val bigIntLongNeg = Sampler.abstractBigInt(125).abs().negate()
        val bigIntShortPos = Sampler.abstractBigInt(31).abs()
    ...
    fun testLongPosDivShortPos255x191(): Unit = repeat(loops) {
        val bigIntLongPos = Sampler.abstractBigInt(255).abs()
        val bigIntShortPos = Sampler.abstractBigInt(191)
    ...
    fun testLongPosDivShortNeg255x191(): Unit = repeat(loops) {
        val bigIntLongPos = Sampler.abstractBigInt(255).abs()
        val bigIntShortNeg = Sampler.abstractBigInt(191).abs().negate()
    ...
    fun testLongNegDivShortPos255x191(): Unit = repeat(loops) {
        val bigIntLongNeg = Sampler.abstractBigInt(255).abs().negate()
        val bigIntShortPos = Sampler.abstractBigInt(191).abs()
